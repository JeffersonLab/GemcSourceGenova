...
env.Library(source = materials_sources, target = "lib/GEMCmaterials")
...
env.Library(source = mirrors_sources, target = "lib/GEMCmirrors")
...
env.Library(source = parameters_sources, target = "lib/GEMCparameters")
...
env.Library(source = util_sources, target = "lib/GEMCutilities")
...
env.Library(source = det_sources, target = "lib/GEMCdetector")
...
env.Library(source = sensi_sources, target = "lib/GEMCsensitivity")
...
env.Library(source = phys_sources, target = "lib/GEMCphysics")
...
env.Library(source = field_sources, target = "lib/GEMCfields")
...
env.Library(source = hitp_sources, target = "lib/GEMChitprocess")
...
output_sources = Split("""
	...
	output/gbank.cc""")
env.Library(source = output_sources, target = "lib/GEMCoutput")
...
gui_sources = Split("""
	...
	gui/src//gtrigger.cc
	utilities/graph.cc""")
env.Library(source = gui_sources, target = "lib/GEMCgui")
...
env.Prepend(LIBS =  ['GEMCmaterials', 'GEMCmirrors', 'GEMCparameters', 'GEMCutilities', 'GEMCdetector', 'GEMCsensitivity', 'GEMCphysics', 'GEMCfields', 'GEMChitprocess', 'GEMCoutput', 'GEMCgui'])
